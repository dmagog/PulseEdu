...
- [ ] Анализ структуры реальной Excel таблицы (сущности, поля, связи)
- [ ] Создание правильных SQLModel моделей (Student, Course, Grade, Group, etc.)
- [ ] Обновление ImportService для работы с реальными данными
- [ ] Создание правильного маппинга полей EXCEL_MAPPING
- [ ] Валидация данных (форматы, диапазоны, обязательные поля)
