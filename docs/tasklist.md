...
- [ ] **Базовые шаблоны**: все страницы наследуют base.html (шапка, подвал, ширина контента)
- [ ] **Единообразие ЛК**: общие элементы управления в одинаковых местах для всех ролей
- [ ] **Навигация**: убрать "Главная" из шапки, сделать иконки ролей кликабельными
...
- [ ] **I18.1 — ЛК студента**: внутренняя навигация, структура разделов
- [ ] **I18.2 — ЛК преподавателя**: дашборд, управление курсами, аналитика
- [ ] **I18.3 — ЛК РОП**: сводки, тренды, управление программами
- [ ] **I18.4 — ЛК администратора**: системные настройки, мониторинг
**Тест:** каждый ЛК имеет логичную структуру и удобную навигацию.

### I19 — **Статус системы**
- [ ] **Веб-интерфейс мониторинга**: красивая страница статуса системы
- [ ] **Техническая диагностика**: детальная информация о компонентах
- [ ] **Метрики производительности**: время отклика, использование ресурсов
- [ ] **История инцидентов**: логи ошибок и восстановления
