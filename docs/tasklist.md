...
| I16 | Структура интерфейса | Главная страница, шапка, подвал, навигация | ⏳ |
| I17 | Hero‑экраны | Главная/онбординг, анимации, RU/EN | ⏳ |
...
- [ ] **Главная страница**: создать рабочую главную страницу с навигацией по ролям
- [ ] **Базовый шаблон**: создать base.html с шапкой и подвалом
- [ ] **Шапка сайта**: вынести в базовый шаблон, унифицировать навигацию
- [ ] **Подвал сайта**: создать сквозной подвал с контактами и ссылками
- [ ] **Навигация**: сгруппировать пункты меню, показать все доступные разделы
- [ ] **Adminer**: добавить в docker-compose для управления БД

#### I16.2 — Страницы курсов и статистика
- [ ] **Страница курса**: детальный просмотр состава курса, дат и мероприятий
- [ ] **Статистика курса**: посещаемость, выполненные мероприятия по курсу
- [ ] **Хронология курса**: лекции, контрольные мероприятия, дедлайны

#### I16.3 — Интерфейс преподавателя
- [ ] **Множественные группы**: поддержка разных студенческих групп в курсе
- [ ] **Дашборд преподавателя**: кластеризация студентов, процент завершения
- [ ] **Зоны риска**: отображение студентов по кластерам риска
- [ ] **Быстрые действия**: поднять блок над "Студенты в зоне внимания"

#### I16.4 — Админ-панель и управление пользователями
- [ ] **Страница пользователей**: реализовать "Все пользователи" в админке
- [ ] **Управление персоналом**: создание и редактирование преподавателей, РОПов, операторов
- [ ] **Назначение прав**: присвоение курсов для наблюдения
- [ ] **Управление студентами**: список, редактирование карточек студентов

**Тест:** все страницы имеют единообразную структуру, навигация работает корректно.

### I17 — **Hero‑экраны** (финальный штрих)
