...
from app.models import student, user, cluster, llm_models
...
def run_migrations():
    ...
    try:
        ...
        alembic_cfg.set_main_option("sqlalchemy.url", os.getenv("DB_URL", "postgresql://pulseedu:pulseedu@localhost:5432/pulseedu"))
